...
public class StudentRepositoryCsv {
    ...
    public void seedFiveStudentsIfEmpty() throws IOException {
        ...
        s1.setProgrammingLanguages(List.of("Java", "Python", "C++"));
        ...
        s3.setProgrammingLanguages(List.of("Python", "Java"));
        ...
        s4.setProgrammingLanguages(List.of("Java", "C++"));
        ...
        s5.setProgrammingLanguages(List.of("C++", "Java"));
